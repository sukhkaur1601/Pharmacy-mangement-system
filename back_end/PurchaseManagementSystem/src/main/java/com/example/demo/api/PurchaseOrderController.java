...
private final PurchaseOrderService purchaseOrderService;
	...
	public void deletePurchaseOrderByid(@PathVariable int id) {
	...
	public Optional<PurchaseOrder> getallOrderById(@PathVariable int id){
		return purchaseOrderService.getallOrderById(id);
	}
	//----------------------For Update Order-----------------------------------
	@PutMapping(value = "/updateOrderProduct/{id}")
	public PurchaseOrder updatePurchaseOrder(@PathVariable int id,@RequestBody PurchaseOrder purchaseOrder) {
	...
	public List<PurchaseOrder> getReport(@RequestParam String from, @RequestParam String  to){
		LocalDate fromDate= LocalDate.parse(from);
		LocalDate toDate=LocalDate.parse(to);
		return purchaseOrderService.getReport(fromDate,toDate);	
	}
