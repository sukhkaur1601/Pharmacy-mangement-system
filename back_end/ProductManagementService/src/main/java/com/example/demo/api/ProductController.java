...
public class ProductController{
	...
	public List<Product> getReport(@RequestParam String from,@RequestParam String to){
		LocalDate fromDate=LocalDate.parse(from);
		LocalDate toDate=LocalDate.parse(to);
		return productService.getReport(fromDate,toDate);
	...
	@CrossOrigin
	@GetMapping(value="/searchproductsavailableforsale", produces=MediaType.APPLICATION_JSON_VALUE)
	public List<Product> searchProductsAvailable(@RequestParam String search){
		return productService.searchProductsAvailable(search);
	}
	@CrossOrigin
