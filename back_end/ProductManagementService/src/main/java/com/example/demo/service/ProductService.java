...
public List<Product> getReport(LocalDate from, LocalDate to) {
	// TODO Auto-generated method stub
...
public List<Product> searchProductsAvailable(String pname) {
	// TODO Auto-generated method stub
	return productRepository.searchAvailableProduct(pname);
}
